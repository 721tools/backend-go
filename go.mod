module github.com/721tools/backend-go
...
require (
	...
	github.com/oh-go/goose v2.1.1+incompatible
...
require (
	github.com/721tools/stream-api-go v0.0.0-20230329124212-39d0f4cc4acf // indirect
